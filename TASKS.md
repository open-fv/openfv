...
### P0.4 — CI templates `[OPUS]` 🟡 (awaiting merge: openfv#6, rtl-lowering#1, sva-frontend#1, btor2-emit#1, fv-engine#1, witness-remap#1, fv-benchmarks#2, fv-debug#1)
